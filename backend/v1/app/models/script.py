...
class Script(Base):
    ...
    template_id: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="关联的灵感模板ID")
    strategy_id: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="关联的创作策略ID")
    used_factors: Mapped[list | dict | None] = mapped_column(JSON, nullable=True, comment="使用的因子列表")
    template_params: Mapped[dict | None] = mapped_column(JSON, nullable=True, comment="模板自定义参数")
