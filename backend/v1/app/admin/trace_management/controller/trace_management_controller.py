...
async def list_traces(
    ...
    result = await trace_management_service.list_traces(
        db=db,
        trace_id=trace_id,
        method=method,
        path=path,
...
async def get_trace_detail(
    ...
    """【后台管理】获取单个Trace的完整详情"""
    result = await trace_management_service.get_trace_detail(db, trace_id)
    return Response.success(data=result)
...
async def get_trace_spans(
    ...
    result = await trace_management_service.get_trace_spans(db, trace_id, include_tree, include_details)
    return Response.success(data=result)
...
async def get_span_detail(
    ...
    result = await trace_management_service.get_span_detail(db, span_id)
    return Response.success(data=result)
...
async def get_trace_statistics(
    ...
    result = await trace_management_service.get_statistics(db, period, user_id, start_time, end_time)
    return Response.success(data=result)
