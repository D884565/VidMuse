...
class VectorizationProcessor(BaseProcessor):
    ...
    def __init__(self,
                 data_key: str = constants.VALID_SLICES,
                 image_key: Optional[str] = "image_url",
                 store_type: str = "slice",
                 meta: Optional[Dict[str, Any]] = None,
                 embedding_model: Optional[str] = None,
                 id_key: str = constants.SLICE_ID):
        """
        初始化向量化处理器
    ...
    def process(self, context: PipelineContext) -> PipelineContext:
        ...
        context_meta = context.get(constants.META_DATA, {})
        ...
        context.set(constants.VECTORIZATION_RESULT, result)
